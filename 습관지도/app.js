...
function setupEventListeners() {
  ...
  // 표지판 예시 팝업
  document.getElementById('signExamplesBtn').addEventListener('click', openSignExamplesModal);
  document.getElementById('signExamplesModalClose').addEventListener('click', closeSignExamplesModal);
  ...
  window.addEventListener('click', (e) => {
    ...
    const signExamplesModal = document.getElementById('signExamplesModal');
    if (e.target === signExamplesModal) {
      closeSignExamplesModal();
    }
  });
}
...
function openSignExamplesModal() {
  document.getElementById('signExamplesModal').classList.add('show');
}

function closeSignExamplesModal() {
  document.getElementById('signExamplesModal').classList.remove('show');
}
